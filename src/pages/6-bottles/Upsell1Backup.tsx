...
function Upsell1Backup() {
  ...
  useEffect(() => {
    ...
    analyticsTracker.trackPageView('/6-bottles/upsell-1-backup');
      ...
      <div className="flex flex-col items-center max-w-md w-full">
        ...
        <div className="relative bg-gray-900 rounded-2xl shadow-2xl overflow-hidden"
          ...
          <div className="relative w-full h-full">
            <iframe
              src="https://scripts.converteai.net/f5ab9e88-cc1b-4dce-a537-c7de7e019d8b/players/686ef444c424df4e29045bae/v4/embed.html"
