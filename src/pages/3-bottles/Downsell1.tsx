...
import { ThreeBottleDownsell1DTC, ThreeBottleDownsell1Copyright } from '../../components/3-bottles';
...
function Downsell1() {
  ...
  useEffect(() => {
    ...
    analyticsTracker.trackPageView('/3-bottles/downsell-1');
  }, []);
  return (
    <>
      <Helmet>
