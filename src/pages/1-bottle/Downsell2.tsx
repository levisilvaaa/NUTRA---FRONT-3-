...
import { OneBottleDownsell2DTC, OneBottleDownsell2Copyright } from '../../components/1-bottle';
...
function Downsell2() {
  ...
  useEffect(() => {
    ...
    analyticsTracker.trackPageView('/1-bottle/downsell-2');
  }, []);
    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen p-4 pt-24">
        <div className="flex flex-col items-center max-w-md w-full">
          ...
          <div className="text-center mb-8 space-y-4">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-2xl p-6 shadow-lg">
              <h2 className="text-xl md:text-2xl font-semibold text-gray-800 leading-relaxed">
                But what about
                <span className="text-yellow-600 font-bold"> 1 bottle with a huge discount</span>
          ...
          <OneBottleDownsell2DTC />

          {/* Space above Copyright */}
          <div className="h-16"></div>

          {/* Copyright Section */}
          <OneBottleDownsell2Copyright />
        </div>
      </div>
