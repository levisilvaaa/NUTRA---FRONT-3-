...
import { OneBottleDownsell1DTC, OneBottleDownsell1Copyright } from '../../components/1-bottle';
...
function Downsell1() {
  ...
  useEffect(() => {
    ...
    analyticsTracker.trackPageView('/1-bottle/downsell-1');
  }, []);
  return (
    <>
      <Helmet>
      ...
      <div className="flex flex-col items-center max-w-md w-full">
        ...
        <div className="text-center mb-2">
          <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-red-600 via-red-500 to-red-700 bg-clip-text text-transparent leading-tight mb-4">
            <span style={{ color: '#fd0000' }}>Not ready to subscribe?</span>
          </h1>
          <h2 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-red-700 via-red-600 to-red-800 bg-clip-text text-transparent mb-4">
            <span className="text-black font-normal">Try the Extended Test: 2 more bottles for only $98</span>
          </h2>
        </div>


        {/* DTC Offer with all content below */}
        <OneBottleDownsell1DTC />
