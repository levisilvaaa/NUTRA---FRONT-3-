...
interface ThreeBottleUpsell1OfferPopupProps {
  isOpen: boolean;
  onClose: () => void;
  sixBottleUrl: string;
  oneBottleUrl: string;
...
const ThreeBottleUpsell1OfferPopup: React.FC<ThreeBottleUpsell1OfferPopupProps> = ({
  isOpen,
  onClose,
  sixBottleUrl,
  oneBottleUrl,
...
export default ThreeBottleUpsell1OfferPopup;