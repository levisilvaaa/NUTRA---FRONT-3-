...
import ThreeBottleDownsell2OfferPopup from './ThreeBottleDownsell2OfferPopup';

const ThreeBottleDownsell2DTC = () => {
  ...
  const scrollToDTC = () => {
    const dtcElement = document.getElementById('threebottle-downsell2-dtc-offers');
    if (dtcElement) {
  ...
  return (
    <div className="mt-6 mb-8 w-full max-w-lg space-y-8" id="threebottle-downsell2-dtc-offers">
        ...
        <div className="bg-gradient-to-br from-red-50 via-white to-red-50 rounded-3xl p-6 pb-8 shadow-2xl border-2 border-red-100 relative overflow-hidden z-10">
          ...
          <div className="text-center mb-3">
            <div className="inline-block bg-gradient-to-r from-red-500 to-red-600 rounded-2xl px-6 py-3 shadow-lg" style={{ animation: 'pulse-scale 1s ease-in-out infinite' }}>
              <p className="font-black text-xl text-white tracking-wide whitespace-nowrap">YOU'RE SAVING $665</p>
            </div>
          </div>
          ...
          <div className="text-center mb-6 space-y-2">
            ...
            <p className="text-red-700 font-bold text-lg tracking-wide">
              COMPLETE 7-MONTHS OF TREATMENT
            </p>
          </div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-white rounded-2xl p-4 border border-red-200 shadow-lg">
              <div className="space-y-2">
                ...
                <p className="text-xl font-black tracking-wide">
                  <span className="text-black">only</span> <span className="text-black">$32</span> <span className="text-black">per bottle</span>
                </p>
                <p className="text-lg font-black tracking-wide">
                  <span className="text-black">Total</span> <span className="text-red-600 line-through">$545</span> <span className="text-black">for just</span> <span className="text-green-600">$128</span>
                </p>
              </div>
            </div>
          </div>
          ...
          {/* CTA Button */}
          <button
            onClick={() => window.open(preserveUTMParams('https://paymaxtestorin.com/ex-ocu/next-offer/AljJaAaYyW?accepted=yes'), '_blank')}
            className="w-full bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:from-green-600 hover:via-green-700 hover:to-green-800 text-white font-black text-lg py-6 rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-300 text-center relative overflow-hidden group mb-4"
            style={{
          ...
          >
            ...
            <div className="relative z-10 space-y-1">
              <div className="text-xl font-black">ADD 4 BOTTLES WITH A SPECIAL DISCOUNT</div>
            </div>
          ...
          {showDeclineButton && (
            <button
              onClick={() => window.open(preserveUTMParams('https://paymaxtestorin.com/ex-ocu/next-offer/AljJaAaYyW?accepted=no'), '_blank')}
              className="w-full bg-transparent border-2 border-red-300 hover:border-red-400 text-red-700 hover:text-red-900 font-bold text-base py-4 rounded-2xl transition-all duration-300 hover:bg-red-50 mb-6 text-center"
            >
      ...
      {/* Offer Popup */}
      <ThreeBottleDownsell2OfferPopup
...
export default ThreeBottleDownsell2DTC;