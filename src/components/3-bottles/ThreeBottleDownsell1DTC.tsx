...
import ThreeBottleDownsell1OfferPopup from './ThreeBottleDownsell1OfferPopup';
import ThreeBottleDownsell1CommentsChat from './ThreeBottleDownsell1CommentsChat';

const ThreeBottleDownsell1DTC = () => {
  ...
  const handleAcceptOffer = () => {
    window.open(preserveUTMParams('https://paymaxtestorin.com/ex-ocu/next-offer/AljJaAaYyW?accepted=yes'), '_blank');
  };

  // Handle decline offer (DO NOT COMPLETE TREATMENT)
  const handleDeclineOffer = () => {
    window.open(preserveUTMParams('https://paymaxtestorin.com/ex-ocu/next-offer/AljJaAaYyW?accepted=no'), '_blank');
  };
  ...
  const scrollToDTC = () => {
    const dtcElement = document.getElementById('threebottle-downsell1-dtc-offers');
    if (dtcElement) {
  ...
  return (
    <div className="mt-6 mb-8 w-full max-w-sm space-y-4" id="threebottle-downsell1-dtc-offers">
        ...
        <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-3xl p-6 pb-8 shadow-2xl border-4 border-blue-200/30 relative overflow-hidden z-10">
          ...
          <div className="text-center mb-3">
            <div className="inline-block bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl px-6 py-3 shadow-lg">
              <p className="font-black text-xl text-black tracking-wide whitespace-nowrap">YOU'RE SAVING $998</p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200 shadow-lg">
              <div className="space-y-2">
                ...
                <p className="text-xl font-bold" style={{ color: '#000000' }}>
                  Total <span className="text-red-600 line-through">$818</span> for just <span className="text-green-600">$180</span>
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ADD 6 MORE BOTTLES AND COMPLETE TREATMENT
          </button>
      ...
      <div className="mt-12">
        <ThreeBottleDownsell1CommentsChat />
      </div>

      {/* Offer Popup */}
      <ThreeBottleDownsell1OfferPopup
...
export default ThreeBottleDownsell1DTC;