...
interface OneBottleDownsell2OfferPopupProps {
  isOpen: boolean;
  onClose: () => void;
  sixBottleUrl: string;
  oneBottleUrl: string;
...
const OneBottleDownsell2OfferPopup: React.FC<OneBottleDownsell2OfferPopupProps> = ({
  isOpen,
  onClose,
  sixBottleUrl,
  oneBottleUrl,
...
export default OneBottleDownsell2OfferPopup;