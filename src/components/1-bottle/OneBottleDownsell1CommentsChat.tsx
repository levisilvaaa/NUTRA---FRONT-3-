...
const OneBottleDownsell1CommentsChat: React.FC = () => {
      ...
      <div className="bg-gradient-to-r from-red-50 via-red-100 to-red-50 p-4 border-b border-red-200 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-center space-x-3 mb-2">
            ...
            <h3 className="text-lg font-black bg-gradient-to-r from-red-600 via-red-500 to-red-700 bg-clip-text text-transparent uppercase tracking-wider">
              LIVE COMMENTS
            </h3>
          </div>
...
export default OneBottleDownsell1CommentsChat;