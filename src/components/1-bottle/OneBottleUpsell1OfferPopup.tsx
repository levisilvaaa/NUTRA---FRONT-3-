...
interface OneBottleUpsell1OfferPopupProps {
  isOpen: boolean;
  onClose: () => void;
  sixBottleUrl: string;
  oneBottleUrl: string;
...
const OneBottleUpsell1OfferPopup: React.FC<OneBottleUpsell1OfferPopupProps> = ({
  isOpen,
  onClose,
  sixBottleUrl,
  oneBottleUrl,
...
export default OneBottleUpsell1OfferPopup;