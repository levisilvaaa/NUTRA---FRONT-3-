...
interface OneBottleDownsell1OfferPopupProps {
  isOpen: boolean;
  onClose: () => void;
  sixBottleUrl: string;
  oneBottleUrl: string;
...
const OneBottleDownsell1OfferPopup: React.FC<OneBottleDownsell1OfferPopupProps> = ({
  isOpen,
  onClose,
  sixBottleUrl,
  oneBottleUrl,
...
export default OneBottleDownsell1OfferPopup;