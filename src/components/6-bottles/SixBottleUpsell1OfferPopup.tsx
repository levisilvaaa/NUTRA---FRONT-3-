...
interface SixBottleUpsell1OfferPopupProps {
  isOpen: boolean;
  onClose: () => void;
  sixBottleUrl: string;
  oneBottleUrl: string;
...
const SixBottleUpsell1OfferPopup: React.FC<SixBottleUpsell1OfferPopupProps> = ({
  isOpen,
  onClose,
  sixBottleUrl,
  oneBottleUrl,
...
export default SixBottleUpsell1OfferPopup;