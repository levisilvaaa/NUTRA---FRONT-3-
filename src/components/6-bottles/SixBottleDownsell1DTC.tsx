...
import SixBottleDownsell1OfferPopup from './SixBottleDownsell1OfferPopup';
import SixBottleDownsell1CommentsChat from './SixBottleDownsell1CommentsChat';

const SixBottleDownsell1DTC = () => {
  ...
  const handleAcceptOffer = () => {
    window.open(preserveUTMParams('https://paymaxtestorin.com/ex-ocu/next-offer/3JVOaqQjGA?accepted=yes'), '_blank');
  };

  // Handle decline offer (DO NOT COMPLETE TREATMENT)
  const handleDeclineOffer = () => {
    window.open(preserveUTMParams('https://paymaxtestorin.com/ex-ocu/next-offer/3JVOaqQjGA?accepted=no'), '_blank');
  };
  ...
  const scrollToDTC = () => {
    const dtcElement = document.getElementById('sixbottle-downsell1-dtc-offers');
    if (dtcElement) {
  ...
  return (
    <div className="mt-6 mb-8 w-full max-w-sm space-y-4" id="sixbottle-downsell1-dtc-offers">
      ...
      <div className="animate-in fade-in duration-500 slide-in-from-bottom-4 relative">
        ...
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
          <div className="relative">
            {/* Main sticker body */}
            <div className="bg-gradient-to-br from-[#ee2a2a] via-[#ee2a2a] to-[#ee2a2a] rounded-2xl px-6 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.4)] border-3 border-[#ee2a2a] relative z-30 animate-[pulse_1s_ease-in-out_infinite]" style={{ animation: 'pulse-scale 1s ease-in-out infinite' }}>
              <div className="flex items-center justify-center space-x-2">
                <span className="text-white font-black text-xl tracking-wider whitespace-nowrap">LAST CHANCE</span>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-3xl p-6 shadow-2xl border-4 border-blue-200/30 relative overflow-hidden z-10">
          ...
          <div className="text-center mb-3">
            <div className="inline-block bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl px-6 py-3 shadow-lg">
              <p className="font-black text-xl text-black tracking-wide whitespace-nowrap">YOU'RE SAVING $890</p>
            </div>
          </div>
          ...
          <div className="text-center mb-3">
            ...
            <p className="text-gray-700 font-bold text-sm tracking-wide mb-4">COMPLETE 9-MONTHS OF TREATMENT</p>
          </div>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200 shadow-lg">
              <div className="space-y-2">
                ...
                <p className="text-xl font-bold" style={{ color: '#000000' }}>
                  Total <span className="text-red-600 line-through">$791</span> for just <span className="text-green-600">$99</span>
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ADD 3 MORE BOTTLES AND COMPLETE TREATMENT
          </button>
      ...
      <div className="mt-12">
        <SixBottleDownsell1CommentsChat />
      </div>

      {/* Offer Popup */}
      <SixBottleDownsell1OfferPopup
...
export default SixBottleDownsell1DTC;