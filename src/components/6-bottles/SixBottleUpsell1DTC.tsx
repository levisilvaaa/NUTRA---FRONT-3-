...
import SixBottleUpsell1OfferPopup from './SixBottleUpsell1OfferPopup';

const SixBottleUpsell1DTC = () => {
  ...
  const acceptedURL = 'https://paymaxtestorin.com/ex-ocu/next-offer/3JVOaqQjGA?accepted=yes';
  const declinedURL = 'https://paymaxtestorin.com/ex-ocu/next-offer/3JVOaqQjGA?accepted=no';
  ...
  const scrollToDTC = () => {
    const dtcElement = document.getElementById('sixbottle-dtc-offers');
    if (dtcElement) {
  ...
  return (
    <div className="mt-6 w-full max-w-sm space-y-4" id="sixbottle-dtc-offers">
      ...
      <div className="animate-in fade-in duration-500 slide-in-from-bottom-4 relative">
        ...
        <div className="bg-gradient-to-br from-red-500 via-red-600 to-red-800 rounded-3xl p-6 shadow-2xl border-4 border-red-400/30 relative overflow-hidden z-10">
          ...
          {/* Product Title */}
          <div className="text-center mb-3">
            <h2 className="text-3xl font-black text-white mb-1 tracking-wide">+ 3 FREE BOTTLES</h2>
            <p className="text-white/90 font-bold text-sm tracking-wide mb-4">COMPLETE THE TREATMENT</p>
          </div>

          {/* Price Info - Moved above CTA */}
          <div className="text-center mb-4 mt-10">
            <p className="text-white/90 text-base font-bold">Activate the Protocol for only $135</p>
          </div>
...
export default SixBottleUpsell1DTC;