...
interface SixBottleDownsell1OfferPopupProps {
  isOpen: boolean;
  onClose: () => void;
  sixBottleUrl: string;
  oneBottleUrl: string;
...
const SixBottleDownsell1OfferPopup: React.FC<SixBottleDownsell1OfferPopupProps> = ({
  isOpen,
  onClose,
  sixBottleUrl,
  oneBottleUrl,
...
export default SixBottleDownsell1OfferPopup;