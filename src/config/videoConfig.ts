...
export const AVAILABLE_VIDEOS: Record<string, VideoConfig> = {
  bakingSoda: {
    ...
    embedUrl: 'https://scripts.converteai.net/f5ab9e88-cc1b-4dce-a537-c7de7e019d8b/players/68fbc04606facf31533282a0/v4/embed.html',
    playerId: '68fbc04606facf31533282a0',
